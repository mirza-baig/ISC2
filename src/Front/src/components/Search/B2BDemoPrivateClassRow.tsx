// Private classes are deferred to a later phase (bug sweep 2026-08-19) — this whole demo row is
// commented out rather than deleted so it can be restored by uncommenting when the feature ships.
// Its render site (SearchResults.tsx) is commented out to match.
